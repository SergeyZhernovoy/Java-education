...
public class UserCreate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean result = userRepository.createUserReferences(req.getParameter("login"),req.getParameter("address"),req.getParameter("role"),req.getParameter("music_type")) != -1 ? true : false;
